...
**Key takeaways:**
- DeepSeek-R1 shattered the "hundreds of millions required" narrative for frontier models
- Chinese open-source models now power nearly 30% of global AI usage, up from 1.2% in late 2024
- AI agents moved from demos to products with real revenue (Manus: $100M ARR)
- Domestic AI chips are gaining market share, with Huawei Ascend at 35-40% of Chinese market
- Talent flow from Silicon Valley to China, while small, would have been unimaginable two years ago

**Tradeoffs:**
- Open-weight models gain global adoption but expose innovations to competitors
- Domestic chips enable sovereignty but lag Nvidia in performance and ecosystem support
- Massive AI app ecosystems drive adoption but create moats blocking new entrants like phone AI agents
